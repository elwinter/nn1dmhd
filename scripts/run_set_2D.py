...
problem = "/homes/winteel1/research/src/nn1dmhd/nn1dmhd/problems/static2.py"
n_layerss = [1, 2, 3, 4]
Hs = [10, 20, 40, 80]
learning_rates = [0.01]
nx_trains = [11]
...
dir_name_template = "%03d/%03d/%5.3f/%04d/%04d/%04d/%5.3f/%06d"
                    ...
                    for nt_train in nt_trains:
                        ...
                        for w_bc in w_bcs:
                            ...
                            cmd = cmd_template % (
                                ...
                                max_epochs, nx_train, ny_train, nt_train, w_bc
                            )
                            print(cmd)
