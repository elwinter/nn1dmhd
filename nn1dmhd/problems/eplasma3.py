...
electric field perturbation E1x.
...
def n1a(xt):
    ...
    Compute the anaytical solution for the density perturbation.
...
def v1xa(xt):
    ...
    Compute the anaytical solution for the x-velocity perturbation.
...
def E1xa(xt):
    ...
    Compute the anaytical solution for the x-electric field perturbation.
