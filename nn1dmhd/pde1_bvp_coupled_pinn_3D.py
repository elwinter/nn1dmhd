...
def create_command_line_argument_parser():
    ...
    parser.add_argument(
        ...
        help="Number of equally-spaced training points in z dimension "
             "(default: %(default)s)"
    )
    parser.add_argument(
        "--nz_val", type=int, default=default_nz_val,
        help="Number of equally-spaced validation points in z dimension "
             "(default: %(default)s)"
    )
    return parser
...
def main():
    ...
    for epoch in range(max_epochs):
        ...
        with tf.GradientTape(persistent=True) as tape0:
            ...
            # There are p.n_var Tensors in the list.
            # Each Tensor has shape ().
            Lm_bc = [tf.math.sqrt(tf.reduce_sum(E**2)/n_train_bc)
                     for E in E_bc]
            ...
            # There are p.n_var Tensors in the list.
            # Each Tensor has shape ().
            Lm = [w_all*loss_all + w_bc*loss_bc
