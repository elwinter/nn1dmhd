...
the full set of MHD equations (11 variables, 11 PDEs). Note that these
equations use the electron number density (n), rather than the mass density
(ρ).
...
E0y = 0.0
E0z = 0.0
initial_values = [n0, P0, u0x, u0y, u0z, B0x, B0y, B0z, E0x, E0y, E0z]
...
def pde_B1z(X, ψ, del_ψ):
    ...
    Evaluate the differential equaztion for z-magnetic field perturbation.
